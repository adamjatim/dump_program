...
class olshop {
	...
	private :
		...
		int sortingInput;
		string sortingBantuAwal, sortingBantu;
};
...
void olshop::menu() {
	cout<<"============================================================="<<endl;
	cout<<"=====                  Yikes Allday                     ====="<<endl;
	cout<<"============================================================="<<endl;
	cout<<"== 1. T-shirt Yikes                             = Rp 24999 =="<<endl;
	cout<<"== 2. Crewneck Yikes                            = Rp 14700 =="<<endl;
	cout<<"== 3. Hoodie Yikes                              = Rp 12999 =="<<endl;
	cout<<"== 4. slipper Yikes                             = Rp 12000 =="<<endl;
	cout<<"== 5. hat yikes                                 = Rp 30999 =="<<endl;
	cout<<"============================================================="<<endl<<endl;
}
...
void olshop::barang_dibeli() {
	...
	do {
		...
		switch(barang[i]) {
			case 1 :
				nama_barang[i] = "T-shirt Yikes";
				harga[i] = 24999;
				break;
			case 2 :
				nama_barang[i] = "Crewneck Yikes";
				harga[i] = 14700;
				break;
			case 3 :
				nama_barang[i] = "Hoodie Yikes";
				harga[i] = 12999;
				break;
			case 4 :
				nama_barang[i] = "slipper Yikes";
				harga[i] = 12000;
				break;
			case 5 :
				nama_barang[i] = "hat yikes";
				harga[i] = 30999;
				break;
		}
...
void olshop::searching(){
	...
	// index looping
	for(int i = 0; i < 20; i++){
		if(sortingInput == 1 && nama_barang[i] == "T-shirt Yikes"){
			if (){
				/* code */
			}
			
			sortingBantuAwal = nama_barang[i];


		}
		else if(sortingInput == 2 && nama_barang[i] == "Crewneck Yikes"){
			
		}
		else if(sortingInput == 3 && nama_barang[i] == "Hoodie Yikes"){
			
		}
		else if(sortingInput == 4 && nama_barang[i] == "slipper Yikes"){
			
		}
		else if(sortingInput == 5 && nama_barang[i] == "hat yikes"){
